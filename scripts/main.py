...
from utils import add_lambda_permission_for_sqs
...
def main(bucket_name: str,
    ...
    sqs_permission_response = add_lambda_permission_for_sqs(queue_name, upload_lambda, aws_region,
                                                            aws_account_id)
    if not sqs_permission_response:
